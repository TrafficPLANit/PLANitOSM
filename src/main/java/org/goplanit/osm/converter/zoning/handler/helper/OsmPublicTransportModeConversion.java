...
public class OsmPublicTransportModeConversion extends OsmModeConversionBase {
   ...
   */
  public Pair<Collection<String>, Collection<PredefinedModeType>> collectPublicTransportModesFromPtEntity(long osmPtEntityId, Map<String, String> tags, String defaultMode) {
