 ...
 *
 */
public class PlanitOsmNetworkLayerModeParser extends PlanitOsmModeParser {
  ...
  private Collection<? extends Mode> getModesForDirection(Map<String, String> tags, boolean isForwardDirection, boolean included) {
    ...
    Set<Mode> foundModes = getSettings().getMappedPlanitModes(PlanitOsmModeUtils.getPostfixedOsmRoadModesWithValueTag(osmDirectionCondition, tags, accessValueTags));
    return foundModes;
  }
  ...
  private Set<Mode> getExplicitlyIncludedModesNonOneWay(Map<String, String> tags) {
    return getSettings().getMappedPlanitModes(PlanitOsmModeUtils.getPrefixedOsmRoadModesWithValueTag(OsmOneWayTags.ONEWAY, tags, OsmOneWayTags.NO));
  }
   ...
   */
  public PlanitOsmNetworkLayerModeParser(PlanitOsmNetworkReaderSettings settings, MacroscopicPhysicalNetwork networkLayer) {
    super(settings);
   ...
   * @return the included planit modes supported by the parser in the designated direction
   */
  public Set<Mode> getExplicitlyIncludedModes(Map<String, String> tags, boolean isForwardDirection, PlanitOsmNetworkReaderSettings settings) {          
    Set<Mode> includedModes = new HashSet<Mode>();     
   ...
   * @return the included planit modes supported by the parser in the designated direction
   */
  public Set<Mode> getExplicitlyExcludedModes(final Map<String, String> tags, final boolean isForwardDirection, final PlanitOsmNetworkReaderSettings settings) {    
    Set<Mode> excludedModes = new HashSet<Mode>();       
