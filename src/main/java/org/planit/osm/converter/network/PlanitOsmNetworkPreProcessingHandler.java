 ...
 *
 */
public class PlanitOsmNetworkPreProcessingHandler extends DefaultOsmHandler {

  /**
   * The logger for this class
   */
  private static final Logger LOGGER = Logger.getLogger(PlanitOsmNetworkPreProcessingHandler.class.getCanonicalName());
   ...
   */
  public PlanitOsmNetworkPreProcessingHandler(final PlanitOsmNetworkReaderSettings settings) { 
