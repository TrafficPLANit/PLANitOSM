...
import org.planit.osm.util.OsmPtVersionSchemeUtils;
...
public class TransferZoneHelper extends ZoningHelperBase{
  ...
  public TransferZone createAndRegisterTransferZoneWithConnectoidsAtOsmNode(
    ...
    for(Mode mode : modeResult.second()) {
      MacroscopicPhysicalLayerImpl networkLayer = (MacroscopicPhysicalLayerImpl) getSettings().getReferenceNetwork().transportLayers.get(mode);             
