...
public class OsmLaneTaggingSchemeHelper{
   ...
   */
  protected static boolean requireTaggingSchemeHelper(OsmNetworkReaderSettings settings, MacroscopicPhysicalLayerImpl networkLayer) {    
  ...
  protected static Set<String> getEligibleTaggingSchemeHelperModes(OsmNetworkReaderSettings settings, MacroscopicPhysicalLayerImpl networkLayer) {
