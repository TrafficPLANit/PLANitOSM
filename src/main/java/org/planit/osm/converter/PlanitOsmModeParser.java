 ...
 *
 */
public class PlanitOsmModeParser {
   ...
   */
  protected PlanitOsmNetworkReaderSettings getSettings() {
   ...
   */
  public PlanitOsmModeParser(final PlanitOsmNetworkReaderSettings settings) {
